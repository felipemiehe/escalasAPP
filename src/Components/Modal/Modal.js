        ...
        <>
            {showModal &&
                <div className="absolute w-full h-full top-[0] left-[0] bg-slate-300 z-50 align-middle bg-opacity-40 ">
                    <div className="overflow-hidden h-full w-full absolute rounded-xl top-[50%] lg:max-w-[900px] xl:max-h-[500px] max-h-[400px] min-h-[400px] min-w-[600px]   left-[50%] transform -translate-x-1/2
